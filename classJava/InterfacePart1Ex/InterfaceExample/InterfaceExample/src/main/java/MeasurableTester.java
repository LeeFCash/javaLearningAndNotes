...
public class MeasurableTester
{
   public static void main(String[] args)
   {
      ...
      Measurable[] employees = new Measurable[2];
      employees[0] = new Employee("Mark", 33, 67000);
      employees[1] = new Employee("Ema", 55, 88000);
       System.out.println(Data.average(employees));
       
       Measurable largerSalary = Data.larger(employees[0], employees[1]);
       Employee eLargeSalary = (Employee)largerSalary;
       System.out.println(eLargeSalary.getName());
       
       Measurable largerCountry = Data.larger(countries[0], countries[1]);
       Country cLarge = (Country)largerCountry;
       System.out.println(cLarge.getName()+ "  " + cLarge.getArea());
